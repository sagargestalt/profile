'use strict';
angular.module('material', ['ngAnimate', 'ngMessages', 'ngResource', 'ui.bootstrap', 'angular-ladda', 'socialLogin', 'base64', 'angularSpinner', 'ngFileUpload', 'ngImgCrop', 'summernote', 'ngTagsInput', 'bootstrapLightbox', 'ngSanitize', 'LocalStorageModule', 'angular-button-spinner', 'hm.readmore']).config(function(socialProvider) {
